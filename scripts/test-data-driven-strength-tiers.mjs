...
const certificationDestination = read('app/(tabs)/ledger/dev-strength-tier-certification.tsx');
...
assert.match(certification, /pathname: '\/\(tabs\)\/ledger\/dev-strength-tier-certification'/, 'DEV certification must enter the real tabbed Ledger route');
...
assert.match(certificationDestination, /strengthTierCertificationFixture/, 'the tab-owned certification route must own deterministic DEV fixture injection');
