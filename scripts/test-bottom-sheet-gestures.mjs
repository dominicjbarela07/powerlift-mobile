...
function harness(reduced=false) {
  ...
  const mocks={react,'@/components/keyboard/KeyboardSurface':{KeyboardScrollView:'ScrollView',KeyboardModal:'Modal'},'@/components/keyboard/keyboard-state':{useKeyboardState:()=>({visible:false,frame:null})},'react-native':{Animated,View:'View',ScrollView:'ScrollView',Modal:'Modal',Keyboard:{dismiss:()=>keyboardDismissals++},AccessibilityInfo:{announceForAccessibility:()=>announcements++},Easing:{out:x=>x,quad:()=>{},linear:()=>{},bezier:()=>{}},StyleSheet:{create:x=>x,absoluteFillObject:{}},useWindowDimensions:()=>({height:850,width:390})},
