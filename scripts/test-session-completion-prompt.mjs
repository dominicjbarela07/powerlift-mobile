...
assert.ok(
  canonicalHandoff.indexOf("type: 'QUEUE_CANONICAL_FINAL_SET'") < canonicalHandoff.indexOf('openTimerPicker(undefined, handoffIdentity)'),
  'the final-session branch must return before the rest picker',
);
assert.match(
