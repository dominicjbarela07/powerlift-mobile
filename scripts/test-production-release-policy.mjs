...
const iosPublisher = readFileSync(
  new URL('./publish-validated-ios-ota.mjs', import.meta.url),
  'utf8',
);
assert.match(iosPublisher, /Production publication is blocked in the iOS-only publisher/);
