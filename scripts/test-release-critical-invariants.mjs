...
const areas = [
  ...
  ['canonical shared athlete and coach post-Session surface', ['scripts/test-canonical-post-session-surface.mjs', 'scripts/test-post-session-times.mjs', 'scripts/test-post-session-related-history.mjs']],
