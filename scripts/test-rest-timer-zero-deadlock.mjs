...
assert.match(logger, /rest=\{activeRestTimer\}/);
assert.doesNotMatch(logger, /setRestSeconds|setRestActive/);
...
assert.match(logger, /snapshot.pending\?\.workoutId === String\(workoutId\)/);
