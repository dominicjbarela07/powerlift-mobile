...
assert.match(coreLoggers, /numberOfLines=\{canonicalMovementCard \? 0 : 2\}[\s\S]*?typographyRole="movementName"/, 'canonical Session Logger movement names must grow instead of ellipsizing');
