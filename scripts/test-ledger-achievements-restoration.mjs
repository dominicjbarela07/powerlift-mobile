...
assert.match(achievements, /resolveLedgerClubsRuntimeState/);
assert.match(rewards, /strengthTierState/);
...
assert.match(data, /fetchLedgerAccomplishmentHistory[\s\S]*fetchLedgerAccomplishmentPage\(50, cursor, athleteId, undefined, eventTypes\)/);
