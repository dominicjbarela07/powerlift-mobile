...
// Native layout, state reconciliation, and content-size changes must never page
// unless a user scroll gesture explicitly armed the boundary guards.
...
// Exercise more gestures than a realistic athlete can produce in one visit.
