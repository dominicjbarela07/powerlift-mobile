...
import { SLErrorState, SLContextualHeader, SLLoadingState, SLScreen } from '@/components/ui';
...
export default function CoachAthleteAnalyticsScreen() {
  ...
  return (
    <SLScreen contentStyle={styles.screen} edges="top" padded={false}>
      <SLContextualHeader
        breadcrumb="Athlete Deep Dive"
        onBack={() => router.back()}
        subtitle={`Progress vs Team · ${period}`}
        title={payload?.athlete.name || 'Athlete Analytics'}
      />
