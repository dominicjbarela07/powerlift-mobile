                  ...
                  {selectedDay?.sessions.length ? (
                    <View style={styles.daySessionList}>
                      {selectedDay.sessions.map((session) => {
                        ...
                        const sessionDuration = sessionDurationPresentation(session);
                                ...
                                <Text style={styles.programmingSessionDate}>
                                  {[
                                    ...
                                    sessionState === 'complete'
                                      ? (sessionDuration && !sessionDuration.isEstimate ? sessionDuration.label : 'Duration not recorded')
                                      : sessionDuration?.label ?? null,
                                  ].filter(Boolean).join(' · ')}
                                </Text>
                              </View>
...
function StoryboardSessionArtwork({ session, style }: { session: HubSession; style?: any }) {
  ...
  return <ProgrammingMuscleRegionArt framingPreset="thumbnail" level="session" primary={focus.primary} secondary={focus.secondary} style={style} />;
}
