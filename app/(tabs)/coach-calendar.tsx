...
const styles = StyleSheet.create({
  ...
  monthContent: { gap: 10, overflow: 'hidden', paddingBottom: 110 },
  ...
  agendaContent: { gap: 18, paddingBottom: 112, paddingTop: 2 },
  agendaGroup: { gap: 9 },
