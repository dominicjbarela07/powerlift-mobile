...
const styles = StyleSheet.create({
  screen: { flex: 1, paddingHorizontal: 10, paddingTop: 10 }, center: { flex: 1, justifyContent: 'center' },
  headerRow: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 }, title: { color: SLColors.textStrong, fontSize: 29, fontWeight: '800' }, subtitle: { color: SLColors.textMuted, fontSize: 13, marginTop: 1 }, iconButton: { alignItems: 'center', backgroundColor: SLColors.object, borderColor: SLColors.borderStrong, borderRadius: 14, borderWidth: 1, height: 44, justifyContent: 'center', width: 44 },
