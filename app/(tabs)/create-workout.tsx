...
const styles = StyleSheet.create({
  ...
  content: { paddingHorizontal: SLSpacing.lg, paddingTop: SLSpacing.sm, paddingBottom: 120, gap: SLSpacing.lg },
  header: { flexDirection: 'row', alignItems: 'flex-start', gap: SLSpacing.sm },
