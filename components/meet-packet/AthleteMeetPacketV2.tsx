...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: SLColors.canvas }, scrollBody: { gap: 14, paddingHorizontal: 14, paddingBottom: 154 }, stack: { gap: 12 }, flex: { flex: 1 }, pressed: { opacity: 0.7 }, disabled: { opacity: 0.45 },
