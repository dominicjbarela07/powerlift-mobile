...
function PerformedMovementCard({ movement, unit, onVideo, initialExpanded = false }: { movement: CompletedRecapMovement; unit: DisplayWeightUnit; onVideo: (set: CompletedRecapSet) => void; initialExpanded?: boolean }) {
