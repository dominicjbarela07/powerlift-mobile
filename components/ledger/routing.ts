...
export const LEDGER_DESTINATIONS: readonly LedgerDestination[] = [
  ...
  { key: 'achievements', entryId: 'ledger-achievements', entryTitle: 'Achievements Hub', title: 'Achievements', label: 'Achievements', icon: 'trophy-outline', description: 'Strength tiers, trophies, medallions, volume accumulation, and PR history.', route: '/(tabs)/ledger/achievements', validationMarker: 'Strength Tier Cabinet' },
