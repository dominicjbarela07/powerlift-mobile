...
export function roundCalculatedWeightForDisplay(value: number, unit: DisplayWeightUnit): number {
...
export function formatCalculatedWeightFromKg(
  ...
  const formatted = formatCalculatedWeightValue(kilogramsToDisplayValue(Number(valueKg), unit), unit);
