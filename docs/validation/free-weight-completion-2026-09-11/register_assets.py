...
source = source.replace('// Canonical DEV database audits: docs/validation/free-weight-{push,pull}-family-2026-09-11.', '// Entire free-weight inventory: docs/validation/free-weight-completion-2026-09-11/asset-manifest.json.')
...
print(f'Registered {len(accepted)} reviewed completion identities; resolver precedence unchanged.')
